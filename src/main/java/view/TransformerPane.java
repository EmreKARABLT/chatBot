...
import Logic.Transformer.TransformerRequestor;
...
public class TransformerPane extends BorderPane {
    ...
    public TransformerPane(MainInterface mainInterface){
        ...
        textField.setOnAction(e ->{
            ...
            String output;
                ...
                TransformerRequestor parser = new TransformerRequestor();
                output = parser.getResponse(textField.getText()+".");
